...
public class JDBC02_execute_executeUpdate {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        /*
 	A) CREATE TABLE, DROP TABLE, ALTER TABLE gibi DDL(tablolarin dis yapisina,ana iskeletine ait komutlar) ifadeleri icin sonuc kümesi (ResultSet)
 	...
 	B) - execute() metodu her tur SQL ifadesiyle kullanilabilen genel bir komuttur.
 	   - execute(), Boolean bir deger dondurur. DDL(drop,alter,create) islemlerinde false dondururken,
 	     DML(insert,update,delete...herhangi bir veri ile ilgili islem yapilmis) islemlerinde true deger dondurur.
    ...
    */
    ...
    git branch -M main
    git remote add origin https://github.com/EdaAltunay/JDBC.git
